...
{
    return GMVector4D(GMMath::SmoothStep(vec1.x, vec2.x, t),
                      GMMath::SmoothStep(vec1.y, vec2.y, t),
                      GMMath::SmoothStep(vec1.z, vec2.z, t),
                      GMMath::SmoothStep(vec1.w, vec2.w, t));
}
...
{
    return equals(vec, GMMath::kDoubleEqThreshold);
}
