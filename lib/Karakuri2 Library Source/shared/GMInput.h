...
// 64キーまでサポート
typedef unsigned long long  GMKeyMask;
...
class GMInput : public GMObject {
    ...
    bool        mIsMouseDownRight;
    bool        mIsMouseDownOldRight;
    bool        mIsMouseDownTriggeredRight;
    bool        mIsMouseUpTriggeredRight;
#endif  //#if !TARGET_OS_IPHONE
...
public:
    /*!
        @task   キーボードの管理 (Mac OS X)
     */

    /*!
        @method     getKeyState
        @abstract   キーの押下情報が格納されたビット列を取得します。
     */
    GMKeyMask   getKeyState() const;
	...
	/*!
		@method     isMouseDownRight
		@abstract   右のマウスボタンが押されていることをチェックします。
		右のマウスボタンにのみ対応します。
     */
    ...
    /*!
		@method     isMouseDownTriggeredRight
		@abstract   右のマウスボタンが押されていることをチェックします。ボタンが押された直後のフレームでしか判定されません。
		右のマウスボタンにのみ対応します。
     */
    bool    isMouseDownTriggeredRight() const;
    ...
    /*!
		@method     isMouseUpRight
		@abstract   右のマウスボタンが押されていないことをチェックします。
		右のマウスボタンにのみ対応します。
     */
    ...
    /*!
		@method     isMouseUpTriggeredRight
		@abstract   右のマウスボタンが押されていないことをチェックします。ボタンが離された直後のフレームでしか判定されません。
		右のマウスボタンにのみ対応します。
     */
    bool    isMouseUpTriggeredRight() const;
...
public:
    ...
    void    __processMouseDownRight();
    void    __processMouseUpRight();
#endif  //#if !TARGET_OS_IPHONE
