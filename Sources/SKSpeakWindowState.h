...
#ifndef __Karakuri2_Mac__SKSpeakWindowState__
#define __Karakuri2_Mac__SKSpeakWindowState__
...
namespace SKSpeakWindow{
    ...
    public:
        ...
        WindowOuter(Window* user, int time);
        ~WindowOuter();
        WindowStateChild* update(GMInput* input, double deltaTime) override;
        void draw(GMSpriteBatch* s) override;
    };
...
#endif /* defined(__Karakuri2_Mac__SKSpeakWindowState__) */
